        ...
        <table className="w-full border-collapse">
          <thead>
            <tr className="bg-slate-50/50 border-b border-slate-200/80">
              <th className="text-left px-6 py-4 text-[11px] font-bold text-slate-500 uppercase tracking-wider">Kode Part (SKU)</th>
              <th className="text-left px-6 py-4 text-[11px] font-bold text-slate-500 uppercase tracking-wider">Nama Suku Cadang</th>
              <th className="text-left px-6 py-4 text-[11px] font-bold text-slate-500 uppercase tracking-wider">Kategori</th>
              <th className="text-right px-6 py-4 text-[11px] font-bold text-slate-500 uppercase tracking-wider">Harga</th>
              <th className="text-center px-6 py-4 text-[11px] font-bold text-slate-500 uppercase tracking-wider">Stok</th>
              <th className="text-center px-6 py-4 text-[11px] font-bold text-slate-500 uppercase tracking-wider">Status Stok</th>
          ...
          <tbody className="divide-y divide-slate-100">
            {spareParts.map((item) => {
              ...
              return (
                ...
                >
                  {/* SKU */}
                  <td className="px-6 py-4 font-mono text-xs font-bold text-slate-900 uppercase">
                  ...
                  {/* Price */}
                  <td className="px-6 py-4 text-right font-mono font-semibold text-slate-900 text-sm">
