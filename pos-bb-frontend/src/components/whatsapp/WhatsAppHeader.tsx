...
export const WhatsAppHeader: React.FC = () => {
  return (
    <div className="flex flex-col gap-4 pb-6 border-b border-slate-200/60 mb-6 animate-fadeIn">
      <div className="flex items-center gap-1.5 text-xs font-semibold text-slate-400">
        <span>Dashboard</span>
        <span>/</span>
        <span className="text-slate-700 font-bold">WhatsApp Automation</span>
      </div>

      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div className="space-y-1.5">
          <div className="flex items-center gap-3">
            {/* Green WhatsApp Icon Container */}
            <div className="w-10 h-10 rounded-xl bg-[#25D366]/15 text-[#128C7E] flex items-center justify-center border border-[#25D366]/30 shadow-xs shrink-0">
          ...
          <p className="text-sm text-slate-500 font-normal leading-relaxed">
            Kelola seluruh automasi WhatsApp, reminder service, template pesan, dan riwayat pengiriman dalam satu tempat.
          </p>
        </div>
      </div>
    </div>
